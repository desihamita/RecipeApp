...
function Delivery() {
    return (
        <div className='w-full bg-white py-16 px-4'>
            ...
            <div className='max-w-[1240px] mx-auto grid sm:grid-cols-1 md:grid-cols-2 gap-6'>
                ...
                <div className='flex flex-col justify-center'>
                    ...
                    <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-4'>Limitless Convenience on-demand</h1>
                    <p>
                    ...
                    <button className='bg-black text-[#00DF9A] w-[200px] rounded-md font-medium my-6 mx-auto sm:mx-0 py-3'>Get Started</button>
                </div>
            </div>
        </div>
    )
