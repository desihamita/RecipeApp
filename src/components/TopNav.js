...
function TopNav() {
    ...
    return (
        <div className='max-w-[1520] mx-auto flex justify-between items-center p-4'>
            ...
            {
                sideNav ? (
                    <div className='bg-black/60 fixed w-full h-screen z-10 top-0 left-0' onClick={() => {
                        return setSideNav(!sideNav)
                    }}></div>
                ): ("")
            }
            ...
            <div className={
                ...
                <AiOutlineClose onClick={() => {
                    return setSideNav(!sideNav)
                }} className='absolute right-4 top-4  cursor-pointer' size={25}/>
                <h2 className='text-2xl p-4'>Yum <span className='text-orange-700 font-bold'>Eats</span></h2>
                <nav>
                    <ul className='flex flex-col p-4 text-gray-900'>
                        <li className='text-xl py-4 flex'>
                          <BsPerson size={25} className='mr-4 p-1 text-white bg-black rounded-full'/> 
                          My Account
                        </li>
                        <li className='text-xl py-4 flex'>
                          <TbTruckReturn size={25} className='mr-4 p-1 text-white bg-black rounded-full'/> 
                          Delivery
                        </li>
                        <li className='text-xl py-4 flex'>
                          <MdOutlineFavorite size={30} className='mr-4 p-1 text-white bg-black rounded-full'/> 
                          My Favourite
                        </li>
                        <li className='text-xl py-4 flex'>
                          <FaGoogleWallet size={25} className='mr-4 p-1 text-white bg-black rounded-full'/> 
                          My Wallet
                        </li>
                        <li className='text-xl py-4 flex'>
                          <MdHelp size={25} className='mr-4 p-1 text-white bg-black rounded-full'/> 
                          Help
                        </li>
                    </ul>
                </nav>
